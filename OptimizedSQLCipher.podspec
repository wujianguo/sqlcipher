# pod lib lint OptimizedSQLCipher.podspec --verbose --allow-warnings 
# pod trunk push OptimizedSQLCipher.podspec --verbose --allow-warnings
Pod::Spec.new do |sqlcipher|
  sqlcipher.name         = "OptimizedSQLCipher"
  sqlcipher.version      = "1.2.2"
  ...
  sqlcipher.description  = <<-DESC
                          ...
                          DESC
  sqlcipher.homepage     = "https://github.com/wujianguo/sqlcipher"
  sqlcipher.license      = { :type => "BSD", :file => "LICENSE"}
  sqlcipher.author             = { "wujianguo" => "lsjustin89@gmail.com" }
  sqlcipher.source       = { :git => "https://github.com/wujianguo/sqlcipher.git", :tag => sqlcipher.version }
  ...
  sqlcipher.osx.deployment_target = "10.10"
